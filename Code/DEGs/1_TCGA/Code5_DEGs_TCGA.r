...
# Load data
# =============================================================================
dds <- readRDS("TCGA_dds_clean_with_SVs.rds")
...
# =============================================================================
design(dds) <- ~ condition+SV1 + SV2 + SV3 + SV4 + SV5 + SV6 + SV7 + SV8 
...
# Save results
# =============================================================================
write.csv(res, "DEGs_TNBC_vs_Healthy_with_SV.csv")
write.csv(as.data.frame(res_sig), "DEGs_TNBC_vs_Healthy_with_SV_significant.csv")
