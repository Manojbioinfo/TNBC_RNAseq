...
# Load data
# =============================================================================
dds <- readRDS("GSE65216_dds_clean_with_SVs.rds")
...
# =============================================================================
design(dds) <- ~ condition+SV1 + SV2 + SV3+SV4+SV5
...
# Save results
# =============================================================================
write.csv(res, "DEGs_GSE65216_vs_Healthy_with_SV.csv")
write.csv(as.data.frame(res_sig), "DEGs_GSE65216_vs_Healthy_with_SV_significant.csv")
