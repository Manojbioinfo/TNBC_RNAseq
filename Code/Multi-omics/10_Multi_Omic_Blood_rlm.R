...
# Set up directories
# =============================================================================
main_dir    <- "Result_Blood"
result_dir  <- file.path(main_dir, "Results_per_Blood")
...
rnaseq  <- readRDS("RNAseq_Blood/rnaseq_aligned.rds")
metab   <- readRDS("RNAseq_Blood/blood_aligned.rds")
