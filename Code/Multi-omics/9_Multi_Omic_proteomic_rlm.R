...
# Set up directories
# =============================================================================
main_dir    <- "Result_proteomic"
result_dir  <- file.path(main_dir, "Results_per_Protein")
...
rnaseq  <- readRDS("RNAseq_Proteomic/rnaseq_aligned.rds")
metab   <- readRDS("RNAseq_Proteomic/proteomic_aligned.rds")
